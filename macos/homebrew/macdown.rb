cask 'macdown' do
  ...
  appcast 'https://github.com/MacDownApp/macdown/releases.atom', checkpoint: '494e6ec6883fd528a9b1905aa3270dfd0361143bfae5bec6b50284b22ef1f966'
  name 'MacDown'
  ...
  zap delete: ['~/Library/Caches/com.uranusjr.macdown','~/Library/Preferences/com.uranusjr.macdown.plist','~/Library/Preferences/com.uranusjr.macdown.LSSharedFileList.plist',]
end
